...
<head>
    <meta charset="utf-8">
    <title>BMW E36 Coupe | Car-branding.pl</title>
    <meta name="description" content="Projekt kompleksowego utworzenia motywu graficznego dla teamu motorsportowego">
                ...
                <ul class="description">
                    ...
                    <li>
                        ...
                        <span class="description__text">Marka i model:
                            <span class="description__text--desc">BMW E36 Coupe</span>
                        </span>
                    </li>
                    <li>
                        <i class="fa fa-gears"></i>
                        <span class="description__text">Typ realizacji:
                            <span class="description__text--desc">kompleksowa kreacja graficzna</span>
                        </span>
                    </li>
                    <li>
