...
<head>
    ...
    <meta name="description" content="Częściowe oklejenie samochodu Kia Picanto dla teamu wyścigowego Wierzbicki.">
                ...
                <ul class="description">
                    ...
                    <li>
                        ...
                        <span class="description__text">Marka i model:
                            <span class="description__text--desc">Kia Picatno</span>
                        </span>
                    </li>
                    <li>
