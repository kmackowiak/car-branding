...
<head>
    ...
    <meta name="description" content="Całściowe oklejnie samochodu BMW E63 przystosowanego na tor wyścigowy dla teamu Palusko">
...
<main>
    <section class="container">
        ...
        <div class="name-bar">
            ...
            <div class="name-bar__title">BMW E36</div>
        </div>

        <div class="realization">
            <div class="gallery">
                <img class="gallery__active-image" src="images/realizations/bmw-e36_palusko_01.jpg" alt="">
                <div class="gallery__thumbnails">
                    <img class="gallery__thumbnail" src="images/realizations/bmw-e36_palusko_01.jpg" alt="">
                    <img class="gallery__thumbnail" src="images/realizations/bmw-e36_palusko_02.jpg" alt="">
                    <img class="gallery__thumbnail" src="images/realizations/bmw-e36_palusko_03.jpg" alt="">
                    <img class="gallery__thumbnail" src="images/realizations/bmw-e36_palusko_04.jpg" alt="">
                </div>
            </div>
                ...
                <ul class="description">
                    ...
                    <li>
                        ...
                        <span class="description__text">Marka i model:
                            <span class="description__text--desc">BMW E36 sedan</span>
                        </span>
                    </li>
                    <li>
                        <i class="fa fa-gears"></i>
                        <span class="description__text">Typ realizacji:
                            <span class="description__text--desc">całościowe oklejenie</span>
                        </span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="description__text">Czas realizacji:
                            <span class="description__text--desc">5 dni</span>
                        </span>
                    </li>
                    <li>
