...
<head>
    ...
    <meta name="description" content="Komlpksowe oklejenie samochodu osobowego Mini Cooper - wersja przystosowana na tor wyścigowy">
                ...
                <ul class="description">
                    ...
                    <li>
                        ...
                        <span class="description__text">Czas realizacji:
                            <span class="description__text--desc">3 dni</span>
                        </span>
                    </li>
                    <li>
                        <i class="fa fa-edit"></i>
                        <span class="description__text">Projekt graficzny:
                            <span class="description__text--desc">#</span>
                        </span>
                    </li>
                </ul>
            </div>
